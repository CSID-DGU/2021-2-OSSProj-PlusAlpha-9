...
#파이게임 배경음악
pygame.mixer.init()
pygame.mixer.music.load("./Sound/Rien.mp3")
# 미사일 효과음
missile1 = pygame.mixer.Sound("./Sound/present1.mp3")
missile1.set_volume(Sound.m_sound)
missile2 = pygame.mixer.Sound("./Sound/present2.mp3")
missile2.set_volume(Sound.m_sound)
missile3 = pygame.mixer.Sound("./Sound/present4.mp3")
missile3.set_volume(Sound.m_sound)
# 피사체 파괴시 효과음
penguin = pygame.mixer.Sound("./Sound/penguin.mp3")
penguin.set_volume(Sound.crash1_sound)
# 피사체와 비행체 충돌시 효과음
boom1 = pygame.mixer.Sound("./Sound/puck.mp3")
...
while not SB:
    ...
    if (Move.space_go == True) and Speed.k % m_speed == Speed.speed_end_point:
        ...
        mm = obj()
        # 미사일의 사진
        mm.put_img('./Image/ice_missile.png')
        # 미사일의 크기 조정
    ...
    if (Move.space_go == True) and (Speed.k%m_speed == Speed.speed_end_point) and Util.score >= Util.score_200:
        ...
        missile2.play()
        mm2 = obj()
        mm2.put_img('./Image/ice_missile.png')
    ...
    if random.random() > Speed.create_rate_c - (Util.score//Util.score_100)/Util.score_100:
        # 피사체 객체 생성
        aa = obj()
        aa.put_img("./Image/penguin2-removebg-preview.png")
        # 피사체의 그림 크기 조정
    ...
    for a in Util.a_list:
        # print(a.sx,a.sy)
        if (a.sx > Size.err_x) or (a.sy > Size.err_y):
            a.put_img("./Image/penguin2-removebg-preview.png")
